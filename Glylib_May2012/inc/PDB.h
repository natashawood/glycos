...
void outputMolPDB_NoRenameResid(molecule* mol, char* file_name); // OG
void outputAsmblPDB_NoRenameResid(assembly* asmbl, char* file_name); // OG
void outputAsmblPDB_NoRenameResidTER(assembly* asmbl, char* file_name); // OG
