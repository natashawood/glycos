...
typedef struct {
	...
	char R; /// Y for part of ring. N for not part of ring. // Added by OG18May2012
...
//
char* spacing(int,int); //Used by output functions to determine spacing OG added
/** @}*/
