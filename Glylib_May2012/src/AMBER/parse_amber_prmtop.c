...
// Function which checks for whitespace in an array and removes it to compare the length to its expected(true) length
int compare_array_ws(int ai, char **a, char *flag, int bi){
/*      printf("ai is %d\n",ai);
        printf("a[0] is %s\n",a[0]);
        printf("flag is %s\n",flag);
        printf("bi is %d\n",bi);
...
// Function to return the number of non-whitespace elements in an array - no comparison to other numbers
int count_array_nws(int ai, char **a, char *flag){
        int ntrue=0,nwhitemid=0,i=0;// ntrue is the number of non-whitespace fields, nwhitemid is the number of non-terminal whitespace residues (>0 will cause error)
        for(i=0;i<ai;i++){
