...
void outputMolPDB_NoRenameResid(molecule* mol, char* file_name)
{
...
void outputAsmblPDB_NoRenameResid(assembly* asmbl, char* file_name)
{
 //Tells the user what's going on
 //printf("Writting file: %s...\n",file_name);
 FILE* file;
...
void outputAsmblPDB_NoRenameResidTER(assembly* asmbl, char* file_name)
{
 //Tells the user what's going on
 //printf("Writting file: %s...\n",file_name);
 FILE* file;
